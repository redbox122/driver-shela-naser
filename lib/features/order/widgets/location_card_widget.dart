              ...
              children: [
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Container(
                    ...
                    child: Text(
                      '${restaurantDistance > 1000 ? '1000+' : restaurantDistance.toStringAsFixed(2)} ${'km_aprox'.tr} ',
                      maxLines: 1,
          ...
          child:
            ...
            Container(
              ...
              padding: const EdgeInsets.symmetric(
                  ...
                  vertical: Dimensions.paddingSizeSmall),
              child: Text(
                '${restaurantToCustomerDistance > 1000 ? '1000+' : restaurantToCustomerDistance.toStringAsFixed(2)} ${'km_aprox'.tr}',
                maxLines: 1,
                overflow: TextOverflow.ellipsis,
                style:
