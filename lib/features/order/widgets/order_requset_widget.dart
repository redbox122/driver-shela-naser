              ...
              child: Column(children: [
                  ...
                  Container(
                    ...
                    child: ClipRRect(
                        ...
                        child: CustomImageWidget(
                          image: parcel
                              ? '${orderModel.parcelCategory != null ? orderModel.parcelCategory!.imageFullUrl : ''}'
                              : orderModel.storeLogoFullUrl ?? '',
                          height: parcel ? 30 : 45,
                          width: parcel ? 30 : 45,
                          fit: BoxFit.cover,
                        )),
                ...
                Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
                  ClipRRect(
                    ...
                    child: Image.asset(Images.dmAvatar,
                  ...
                  child: Row(children: [
                    ...
                    Expanded(
                        child: CustomButtonWidget(
                            ...
                            buttonText: orderModel.module_id == 8
                                ? "addRequest".tr
                                : 'accept'.tr,
                                  ...
                                  : Get.dialog(
                                      ConfirmationDialogWidget(
                                        ...
                                        description: orderModel
                                                    .collectionOrder ==
                                                true
                                            ? "thisOrderHaveManyOrderForSameUserUMustAcceptThem"
                                                .tr
                                            : parcel
                                                ...
                                                : 'you_want_to_accept_this_order'
                                                    .tr,
                                        onYesPressed: () {
                                          if (orderModel.collectionOrder ==
                                              true) {
                                            for (int id
                                                in orderModel.groupOrder ??
                                                    []) {
                                              orderController
                                                  .acceptOrder(
                                                      id, index, orderModel)
