...
class OrderController extends GetxController implements GetxService {
  ...
  Future<bool> updateOrderStatus(OrderModel currentOrder, String status, {bool back = false,  String? reason, bool? parcel = false, bool gotoDashboard = false}) async {
    ...
    UpdateStatusBodyModel updateStatusBody = UpdateStatusBodyModel(
      ...
      otp: status == AppConstants.delivered||status == AppConstants.pickedUp || (parcel! && status == AppConstants.pickedUp) ? _otp : null,
    );
  ...
  Future<bool> addRequest(orderId,){
   return orderServiceInterface.setPriceService(orderId, double.parse(priceRequest.text));
