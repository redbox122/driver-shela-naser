...
import 'package:shellafood_delivery/features/profile/widgets/profile_bg_widget.dart';
import 'package:shellafood_delivery/features/profile/widgets/profile_button_widget.dart';
import 'package:shellafood_delivery/features/profile/widgets/profile_card_widget.dart';
                    ...
                    child: Center(
                      ...
                      child: Column(children: [
                        ...
                        ProfileButtonWidget(
                          ...
                          isButtonActive:
                              Get.find<AuthController>().notification,
                          onTap: () {
                            Get.find<AuthController>().setNotificationActive(
                                !Get.find<AuthController>().notification);
                          },
                        ),
                        const SizedBox(height: Dimensions.paddingSizeSmall),
