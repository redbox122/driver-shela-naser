...
import 'package:shellafood_delivery/features/address/domain/models/address_model.dart';
import 'package:shellafood_delivery/features/address/domain/models/zone_model.dart';
import 'package:shellafood_delivery/features/address/domain/models/zone_response_model.dart';
...
class AddressController extends GetxController implements GetxService {
  ...
  void _setLocation(LatLng location) async {
    ...
    if (response != null && response.isSuccess && response.zoneIds.isNotEmpty) {
      ...
      _selectedZoneIndex = addressServiceInterface.setSelectedZoneIndex(
          _zoneIds, _selectedZoneIndex, _zoneList);
    } else {
      _restaurantLocation = null;
      _zoneIds = null;
    }
