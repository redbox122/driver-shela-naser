...
class AddRequestPrice extends StatelessWidget {
  final String icon;
  ...
  const AddRequestPrice({super.key, required this.icon, this.iconSize = 50, this.title, required this.description, required this.onYesPressed,
...
CustomTextFieldWidget(
  hintText: "yourPriceWithTransportFee".tr,
  inputType: TextInputType.number,
  showTitle: true,
  controller: Get.find<OrderController>().priceRequest,
),
          SizedBox(height: 10,),
